...
const ReviewCard: NextComponentType<NextPageContext, any, ReviewCardProps> = (props: ReviewCardProps) => {
    return (
        <div>
            <blockquote className="p-4 mb-8 bg-gray-100 rounded-lg mx-8 shadow-md">
                <div className="flex items-center">
                    ...
                    <div className="ml-4">
                        <p className="mt-1 text-lg font-medium text-gray-600">{props.name}</p>
